...
logger = setup_logger('Data Prepare', r'E:\Code\Molecule\MultiMol\datasets', filename="data_log.txt")
...
def parse():
    ...
    parser.add_argument('--data', type=str,
                        default=r'E:\Code\Molecule\MultiMol\data\chem_dataset\chembl_filtered\raw\smiles.csv', help='Path to molecule corpus')
