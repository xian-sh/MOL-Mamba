...
class Args:
    save_dir = f'E:/Code/Molecule/MultiMol/baselines/{model_name}_all'
...
if __name__ == '__main__':
    ...
    trainloader = DataLoader(test_dataset+valid_dataset, batch_size=args.batchsize, shuffle=True)
    ...
    model = GNN_graphpred(args=args, num_tasks=num_tasks, molecule_model=GNN_model)
